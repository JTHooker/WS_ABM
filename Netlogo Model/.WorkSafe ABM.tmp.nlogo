...
to DisputeToClaimAccepted
  if InSystem = 1 and Success_Dispute_% > random 100 and InDispute = 1 and any? Disputes-here [
    face one-of Treatments fd speed set GoingToTreatment 1 set satisfaction satisfaction set CostsTreatment (CostsTreatment + one-of [ 1 0 ])  ]
  if GoingToTreatment = 1 [ face one-of Treatments fd speed if any? Treatments in-radius 1 [ move-to one-of Treatments set InTreatment 1 set GoingToTreatment 0 set indispute 0 ]]
