...
if Acute_to_Accepted > random 100 and InAcuteCare = 1 and any? AcuteCares-here [
    ...
    if GoingtoClaimAcceptedt = 1 [ face one-of ClaimAccepteds fd speed  ]
      if any? ClaimAccepteds in-radius 1 [ move-to one-of  Set InReviewWorker 1 Set InClaimAccepted 0 set GoingtoreviewPatient 0 ]
end
