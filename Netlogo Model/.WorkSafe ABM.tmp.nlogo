...
to performance
   set time time + 1
   user-message (word "You have a new text message from the chair. Hi " name ", Bruce here - just checking in after the Board meeting today - I'm sure everythingin hand ...but just confirming the changes we talked about?")
